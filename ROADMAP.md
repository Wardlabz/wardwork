...
- [x] **Issue 2.1: Auth System**
    ...
    - [x] 2.1.2: `ApiKeyGuard` (Authenticates `wwk_` keys).
    - [x] 2.1.3: `ScopeGuard` (Enforces `read`, `write`, `support`).
    - [x] 2.1.4: Short-lived token logic (`wwk_tok_`) for frontend use.
...
- [ ] 9.4: Installer script `npm create wardwork-orchestrator@latest`.
...
2. Installer Script `npm create wardwork-orchestrator@latest`
