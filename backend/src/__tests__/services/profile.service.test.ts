...
describe('ProfileService - getProfileByUserId', () => {
  ...
  describe('Database errors', () => {
    it('should throw error on database connection issues', async () => {
      ...
      await expect(profileService.getProfileByUserId(mockUserId))
        .rejects
        .toThrow('Failed to fetch profile: Database connection failed');
    });
    ...
    it('should throw error on unexpected database errors', async () => {
      ...
      await expect(profileService.getProfileByUserId(mockUserId))
        .rejects
        .toThrow('Failed to fetch profile: Unexpected error');
    });
