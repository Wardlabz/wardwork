...
All API endpoints in the wardwork backend now use a standardized response format to ensure consistency across all controllers and improve frontend error handling.
