...
The edit/delete flow was manually tested on https://www.wardwork.org using the project created during the add-portfolio test. Screenshots should be attached to the PR description so they are hosted by GitHub and are not committed to the repository.
...
The project title was changed from `WardWork Portfolio Flow QA Test` to `WardWork Portfolio Flow QA Test - Edited` before saving. The deleted project no longer appeared on the portfolio page after deletion.
