...
The edit/delete flow was manually tested on https://www.wardwork.org using the project created during the add-portfolio test. Screenshots are included in `reports/issue-1356/screenshots/`.
