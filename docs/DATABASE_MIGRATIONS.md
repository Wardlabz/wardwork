...
This document explains how to create and manage database migrations for the WardWork project using Supabase.
...
WardWork uses Supabase for database management. All database changes are tracked through SQL migration files located in `/backend/supabase/migrations/`.
