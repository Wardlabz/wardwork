# Contributing to WardWork

Thank you for your interest in contributing to WardWork! We welcome contributions from the community and are excited to have you on board.
...
1. **Fork the repository**
   ...
   Click the "Fork" button at the top right of the [repository page](https://github.com/your-username/wardwork-monorepo).

2. **Clone your fork**

   ```bash
   git clone https://github.com/YOUR-USERNAME/wardwork-monorepo.git
...
3. **Add upstream remote**
   ...
   ```bash
   git remote add upstream https://github.com/original-owner/wardwork-monorepo.git
   ```
...
- Search [existing issues](https://github.com/your-username/wardwork-monorepo/issues) to see if the bug is already reported
...
3. **Create a discussion**: Use [GitHub Discussions](https://github.com/your-username/wardwork-monorepo/discussions)
...
Thank you for contributing to WardWork! 🚀
