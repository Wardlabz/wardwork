...
Welcome to WardWork! This guide will help you set up the project and understand our contribution workflow.
...
1. Go to [WARDWORK/wardwork](https://github.com/WARDWORK/wardwork)
...
git clone https://github.com/YOUR_USERNAME/wardwork.git

# Navigate to the project directory
cd wardwork

# Add the upstream remote (original repository)
git remote add upstream https://github.com/WARDWORK/wardwork.git

# Verify remotes
git remote -v
# origin    https://github.com/YOUR_USERNAME/wardwork.git (fetch)
# origin    https://github.com/YOUR_USERNAME/wardwork.git (push)
# upstream  https://github.com/WARDWORK/wardwork.git (fetch)
# upstream  https://github.com/WARDWORK/wardwork.git (push)
```
