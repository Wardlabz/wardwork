...
WardWork is a comprehensive platform designed to help professionals manage their job offers, track salary negotiations, and make informed career decisions. Whether you're a job seeker comparing multiple offers or a professional planning your next career move, WardWork provides the tools and insights you need.
...
- **Issues**: [GitHub Issues](https://github.com/your-username/wardwork-monorepo/issues)
- **Discussions**: [GitHub Discussions](https://github.com/your-username/wardwork-monorepo/discussions)
