...
This document describes the architecture and structure of the WardWork project.
...
WardWork is a decentralized freelance platform built with modern web technologies and blockchain integration. The system follows a layered architecture with clear separation of concerns.
