...
### Archivo .env
```bash
# WardWork Contract Addresses - Futurenet
...
const { userRegistry, escrow, publication, rating, dispute } = useWardWork();
```
...
**¡TODOS LOS 9 CONTRATOS** de WardWork han sido desplegados exitosamente en Futurenet y están listos para ser usados en tu aplicación frontend!
