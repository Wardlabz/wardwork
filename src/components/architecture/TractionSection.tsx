        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-2xl bg-bg-base shadow-neu-sunken p-5 text-sm text-content-secondary leading-relaxed mt-2">
              Traditional platforms (Upwork, Fiverr) cannot pay unbanked LATAM freelancers directly. WardWork + Stellar + BlindPay + Abroad closes this gap: any freelancer with a mobile wallet receives USDC-settled payments in seconds, converted to local fiat via established licensed corridors.
            </div>
          </div>
