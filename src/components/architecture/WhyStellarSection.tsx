      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-5xl mx-auto">
          ...
          <div className="rounded-[2rem] bg-bg-elevated shadow-neu-raised-l2-sm p-7 flex flex-col gap-4">
            ...
            <p className="text-sm text-content-secondary leading-relaxed">
              Soroban enables programmable, audited escrow logic on Stellar. WardWork integrates TrustlessWork&apos;s open-source Soroban contracts rather than building from scratch — leveraging already-audited code and contributing to Stellar&apos;s composable DeFi layer.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] bg-bg-elevated shadow-neu-raised-l2-sm p-7 flex flex-col gap-4">
            ...
            <p className="text-sm text-content-secondary leading-relaxed">
              Stellar Wallets Kit allows client-side transaction signing. Funds never pass through WardWork&apos;s servers. This is the correct model for a marketplace handling freelancer payments at scale — WardWork cannot freeze, redirect, or lose user funds.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] bg-bg-elevated shadow-neu-raised-l2-sm p-7 flex flex-col gap-4">
            ...
            <h3 className="text-base font-bold text-content-primary">Ecosystem value WardWork adds</h3>
            <p className="text-sm text-content-secondary leading-relaxed">
              WardWork brings real freelance transaction volume to Stellar mainnet. Every completed order is an on-chain USDC escrow release followed by a fiat settlement via a Stellar anchor. Open-sourcing the SWK + BlindPay + Abroad adapters in T3 creates reusable building blocks for any future Stellar marketplace.
            </p>
          </div>
