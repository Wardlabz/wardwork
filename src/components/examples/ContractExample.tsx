...
import { useWardWork, VerificationLevel } from '@/hooks/contracts';
import { getContractConfig } from '@/config/contracts';

/**
 * Example component demonstrating how to use WardWork contract hooks
...
export const ContractExample: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">WardWork Contract Example</h1>
