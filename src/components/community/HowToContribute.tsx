...
const steps = [
    {
        number: "01",
        title: "Fork",
        description: "Fork the repository to your own GitHub account.",
    },
    {
        number: "02",
        title: "Clone",
    ...
    },
    {
        number: "04",
        title: "Make changes",
        description: "Write your code, commit, and push to your fork.",
    },
    {
        number: "05",
        title: "Open PR",
        description: "Submit a Pull Request to the main repository.",
    },
    {
        number: "06",
        title: "Get reviewed",
        description: "Address any feedback from the maintainers.",
    },
    {
        number: "07",
        title: "Merged",
        description: "Your changes are merged into the project!",
    },
];
...
const contributionTypes = [
    ...
    {
        title: "Docs",
        description: "Improve our documentation, tutorials, and guides.",
        icon: BookOpen,
    },
    {
        title: "Design",
        description: "Contribute to UI/UX, create assets, and refine the design system.",
        icon: PenTool,
    },
    {
        title: "Bug reports",
        description: "Find issues? Let us know so we can fix them together.",
        icon: Bug,
    },
];
                        ...
                        {contributionTypes.map((type, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <h4 className="text-lg font-bold" style={{ color: "#19213D" }}>
                                        {type.title}
                                    </h4>
