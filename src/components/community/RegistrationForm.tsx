    ...
    if (isSubmitted) {
        return (
            <div className="py-24 bg-transparent flex flex-col items-center justify-center text-center px-6">
                ...
                <p className="text-[#6D758F] max-w-sm font-medium">We&apos;ll reach out shortly to discuss your integration with WardWork.</p>
            </div>
        );
    }
        ...
        <section id="waitlist-form" className="py-32 bg-transparent relative">
            <div className="mx-auto max-w-2xl px-6">
                ...
                >
                    ...
                    {/* Purpose Field */}
                    <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-[#6D758F] ml-2">For what would you use WardWork?</label>
                        <div className="relative group">
