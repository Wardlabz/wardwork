...
const defaultSocialLinks: SocialLink[] = [
  ...
  { label: "Telegram", href: "https://t.me/wardwork_contributors", icon: "telegram" },
  { label: "GitHub", href: "https://github.com/WARDWORK/wardwork", icon: "github" },
]
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="pt-8 border-t border-secondary-100">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-sm text-secondary-400">© {new Date().getFullYear()} WARDWORK. All rights reserved.</p>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 items-center">
            ...
            <div className="text-center order-2">
              <h2 className="text-2xl font-bold text-[#1e1e1e]">WARDWORK</h2>
