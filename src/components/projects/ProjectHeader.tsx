    ...
    <div className="flex items-center justify-between px-4 sm:px-6 py-3">
      <div className="flex items-center gap-3">
        <div className="h-9 w-9 rounded-full bg-white p-[2px] ring-1 ring-slate-200 shadow-sm">
          <Image src="/oh-logo.png" alt="WardWork logo" width={32} height={32} className="rounded-full" />
        </div>
        <span className="text-slate-800 font-semibold select-none">WardWork</span>
      </div>
