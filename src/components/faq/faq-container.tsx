...
const faqData = {
  "General Questions": [
    {
      question: "What is WardWork?",
      answer:
        "WardWork is a platform that connects talented freelancers with clients looking for professional services. Our platform makes it easy to find the right talent for your project or find work opportunities if you're a freelancer.",
    },
    {
    ...
    {
      question: "Is WardWork free to use?",
      answer:
        "WardWork offers both free and premium plans. The basic features are available for free, while advanced features require a subscription.",
    },
    {
      question: "Which countries does WardWork support?",
      answer:
        "WardWork is available worldwide, with specific payment methods and features varying by region. Check our regional availability page for details.",
    },
  ],
  "Payments & Billing": [
    {
  ...
  "Security & Privacy": [
    {
      question: "How does WardWork protect my data?",
      answer:
  ...
  "Technical Support": [
    {
      ...
      answer:
        "WardWork works best on the latest versions of Chrome, Firefox, Safari, and Edge. We recommend keeping your browser updated for optimal performance.",
    },
    {
    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      ...
      <header className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center">
            <span className="text-xl font-bold text-[#15949C]">WardWork</span>
          </Link>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <p className="text-[#7a8a9a] dark:text-gray-300 max-w-2xl mx-auto">
          Find answers to the most common questions about WardWork and how our
          platform works.
        </p>
      </div>
