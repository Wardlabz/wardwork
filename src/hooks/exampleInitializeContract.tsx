...
export const ExampleInitializeContract = () => {
  ...
  const payload = {
    ...
    platformFee: "3", // Commission that WardWork will receive when the escrow is released or resolved. You must choose how much you want to receive.
    ...
    roles: {
      ...
      platformAddress:
        "GAWVVSA6OUB2T2A6Q4E4YS75PO32YK7TKQJQDODA4GAY7SHGQOETVYPD", // WardWork
      releaseSigner: "GAWVVSA6OUB2T2A6Q4E4YS75PO32YK7TKQJQDODA4GAY7SHGQOETVYPD", // WardWork
      disputeResolver:
