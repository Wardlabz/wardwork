...
const categories = [
  {
    ...
    title: "Browse FAQ",
    description: "Find answers to the most common questions about using WardWork.",
    linkText: "View FAQ",
    linkHref: "#",
  },
  {
  ...
  },
  {
    ...
    description: "Watch step-by-step tutorials to learn how to use WardWork effectively.",
