...
const sections: TermsSection[] = [
    ...
    blocks: [
      {
        ...
        children: (
          <>
            By accessing or using the WARDWORK platform, website, or any related services (collectively, the
      ...
      },
      {
        ...
        children: (
          <>
            These Terms constitute a legally binding agreement between you and WARDWORK (&quot;Company&quot;,
    ...
    blocks: [
      {
        ...
        children: (
          <>
            WARDWORK is a decentralized-friendly marketplace platform that connects <strong>Clients</strong>{" "}
      ...
      },
      {
        ...
        children: (
          <>
            WARDWORK acts solely as an intermediary technology platform. We do <strong>not</strong> employ, supervise,
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "h3", children: "3.2 Account Responsibility" },
      {
        ...
        children: (
          <>
            You are solely responsible for all activity that occurs under your account. WARDWORK shall not be liable for
      ...
      },
      {
        ...
        items: [
          ...
          <>
            ...
            behavior toward any user or WARDWORK staff.
          </>,
          <>
  ...
  },
  {
    ...
    blocks: [
      { type: "h3", children: "6.1 Escrow Protection" },
      {
        ...
        children: (
          <>
            WARDWORK integrates with <strong>Trustless Work</strong> smart contracts on the{" "}
      ...
      { type: "h3", children: "6.2 Platform Fees" },
      {
        ...
        children: (
          <>
            WARDWORK charges service fees for facilitating transactions. Current fee structures are published on the
      ...
      { type: "h3", children: "6.3 Currency and Conversion" },
      {
        ...
        children: (
          <>
            Transactions on WARDWORK may involve digital assets and fiat currencies. Conversion rates and associated
            costs are determined by integrated service providers (e.g., Airtm). WARDWORK is not responsible for exchange
      ...
      { type: "h3", children: "6.4 Taxes" },
      {
        ...
        children: (
          <>
            ...
            conducted through the Platform. WARDWORK does not withhold taxes on your behalf unless required by
      ...
      { type: "h3", children: "6.5 Refunds and Disputes" },
      {
        ...
        children: (
          <>
            ...
            process. WARDWORK does not guarantee refunds for completed transactions outside of a formally adjudicated
            dispute.
          </>
        ),
      },
    ...
    blocks: [
      {
        ...
        children: (
          <>
            The WARDWORK Platform utilizes blockchain technology and smart contracts for certain payment functions. You
      ...
      },
      {
        ...
        items: [
          <>
            ...
            WARDWORK cannot reverse or cancel confirmed on-chain transactions.
          </>,
          <>
            <strong>Smart Contract Risk:</strong> Smart contracts may contain bugs or vulnerabilities despite security
            audits. WARDWORK is not liable for losses arising from smart contract exploits beyond our reasonable control.
          </>,
          <>
            <strong>Network Risk:</strong> Blockchain network congestion, forks, or outages may delay or affect
            transactions. WARDWORK is not responsible for delays caused by network-level events.
          </>,
          <>
            <strong>Wallet Responsibility:</strong> You are solely responsible for securing your blockchain wallet and
            private keys. Loss of keys may result in permanent loss of funds. WARDWORK cannot recover lost private
            keys.
          </>,
          <>
  ...
  },
  {
    ...
    blocks: [
      { type: "h3", children: "8.1 Platform Ownership" },
      {
        ...
        children: (
          <>
            The WARDWORK Platform, including but not limited to its software, design, branding, algorithms, databases,
            and documentation, is owned by WARDWORK or its licensors and is protected by copyright, trademark, patent,
      ...
      { type: "h3", children: "8.2 User Content License" },
      {
        ...
        children: (
          <>
            ...
            descriptions, messages, and deliverables), you grant WARDWORK a non-exclusive, worldwide, royalty-free,
    ...
    blocks: [
      {
        ...
        children: (
          <>
            ...
            <Link
              href="https://wardwork.tech/privacy"
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        children: (
          <>
            WARDWORK is not a party to confidentiality obligations between Clients and Freelancers. We recommend
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "h3", children: "11.2 No Liability for User Conduct" },
      {
        ...
        children: (
          <>
            WARDWORK is not responsible for the conduct, actions, or omissions of any user on or off the Platform. We
      ...
      { type: "h3", children: "11.3 Limitation of Liability" },
      {
        ...
        children: (
          <>
            TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WARDWORK&apos;S TOTAL LIABILITY TO YOU FOR ANY CLAIM
      ...
      },
      {
        ...
        children: (
          <>
            IN NO EVENT SHALL WARDWORK BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
      ...
      { type: "h3", children: "11.4 Indemnification" },
      {
        ...
        children: (
          <>
            You agree to indemnify, defend, and hold harmless WARDWORK and its officers, directors, employees, and
  ...
  },
  {
    ...
    blocks: [
      { type: "h3", children: "12.1 Platform Disputes" },
      {
        ...
        children: (
          <>
            For disputes between Clients and Freelancers regarding deliverables, payments, or project conduct, WARDWORK
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        children: <>WARDWORK reserves the right to:</>,
      },
      {
        type: "ul",
        items: [
    ...
    blocks: [
      {
        ...
        children: (
          <>
            ...
            privacy policies. WARDWORK is not responsible for the practices or content of any third-party service.
          </>
        ),
      },
    ],
    ...
    blocks: [
      {
        ...
        children: (
          <>
            The WARDWORK platform is an open-source project. Contributions to the codebase are governed by the
    ...
    blocks: [
      {
        ...
        children: (
          <>
            ...
            constitute the entire agreement between you and WARDWORK regarding your use of the Platform, and supersede
