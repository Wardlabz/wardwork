        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 py-24">
          <header className="text-center mb-12">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-text-primary">
              The rules for using WARDWORK.
            </h1>
            <p className="mt-4 text-base sm:text-lg font-light max-w-2xl mx-auto text-text-secondary">
              These Terms of Service explain what you can expect from WARDWORK
          ...
          <div className="space-y-6">
            <section className="rounded-2xl bg-background shadow-raised p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                WARDWORK is a marketplace that connects independent
            ...
            <section className="rounded-2xl bg-background shadow-raised p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                To keep WARDWORK safe and reliable for everyone, you agree to
              ...
              <ul className="mt-4 space-y-2 text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                ...
                <li>
                  • Use WARDWORK only for lawful purposes and never to engage
            ...
            <section className="rounded-2xl bg-background shadow-raised p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                The WARDWORK platform, including its design, software,
              ...
              <ul className="mt-4 space-y-2 text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                ...
                <li>
                  • By posting or uploading content to WARDWORK, you grant us a
                ...
                <li>
                  • All WARDWORK names, logos, and related marks are our
            ...
            <section className="rounded-2xl bg-background shadow-raised p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                WARDWORK is provided on an &quot;as is&quot; and &quot;as
              ...
              <p className="mt-4 text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                To the maximum extent allowed by applicable law, WARDWORK and
              ...
              <p className="mt-4 text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                ...
                amount you paid to WARDWORK for use of the service in the
            ...
            <section className="rounded-2xl bg-background shadow-raised p-6 sm:p-8">
              ...
              <p className="mt-4 text-sm sm:text-base font-light leading-relaxed text-text-secondary">
                By accessing or using WARDWORK, you confirm that you have read,
