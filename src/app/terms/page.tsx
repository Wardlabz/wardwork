            ...
            {[
              {
                ...
                content: "WARDWORK is a marketplace that connects independent professionals, teams, and businesses to discover, manage, and complete work using blockchain-backed agreements and payments. We provide tools for discovery, messaging, contract management, and transaction tracking, but we do not directly participate in or control the engagements between users.",
                bullets: [
              ...
              },
              {
                ...
                content: "To keep WARDWORK safe and reliable for everyone, you agree to use the platform responsibly and in compliance with all applicable laws and regulations.",
                bullets: [
                  ...
                  "Use WARDWORK only for lawful purposes, avoiding fraud, harassment, or money laundering.",
              ...
              },
              {
                ...
                content: "The WARDWORK platform, including its design, software, branding, and underlying technology, is owned by us or our licensors and is protected by copyright, trademark, and other intellectual property laws.",
                bullets: [
                  ...
                  "All WARDWORK marks are our trademarks and require consent for use."
                ]
              },
              {
                icon: HelpCircle,
