...
export const metadata: Metadata = {
  title: "Quick Start - WARDWORK Documentation",
  description: "Get started with WARDWORK in minutes",
};
  ...
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <p style={{ color: "#6D758F", fontSize: "1.125rem" }}>
        Get WARDWORK up and running in your marketplace in less than 10 minutes.
      </p>
      ...
      >
        <code>git clone https://github.com/your-org/wardwork.git</code>
        {"\n"}
        <code>cd wardwork</code>
      </pre>
