...
export const metadata: Metadata = {
  title: "Installation - WARDWORK Documentation",
  description: "Complete installation guide for WARDWORK",
};
  ...
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <p style={{ color: "#6D758F", fontSize: "1.125rem" }}>
        Complete installation guide for deploying WARDWORK in production.
      </p>
      ...
      <p style={{ color: "#6D758F" }}>
        Create a PostgreSQL database for WARDWORK:
      </p>
