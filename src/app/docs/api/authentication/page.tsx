...
export const metadata: Metadata = {
  title: "Authentication - WARDWORK API Reference",
  description: "API authentication guide for WARDWORK",
};
  ...
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <p style={{ color: "#6D758F", fontSize: "1.125rem" }}>
        All API requests to WARDWORK require authentication via API keys.
      </p>
