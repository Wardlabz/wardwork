...
export const metadata: Metadata = {
  title: "Core Concepts - WARDWORK Documentation",
  description: "Understand the core concepts behind WARDWORK",
};
  ...
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <p style={{ color: "#6D758F", fontSize: "1.125rem" }}>
        Learn the fundamental concepts that power WARDWORK's payment orchestration.
      </p>

      <h2 style={{ color: "#19213D" }}>Non-Custodial Architecture</h2>

      <p style={{ color: "#6D758F" }}>
        WARDWORK never holds your funds. All escrow operations happen on-chain via
