...
export const metadata: Metadata = {
  title: "Orders Guide - WARDWORK Documentation",
  description: "Learn how to manage orders in WARDWORK",
};
  ...
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <p style={{ color: "#6D758F", fontSize: "1.125rem" }}>
        Orders are the foundation of WARDWORK's escrow system. Learn how to create,
