...
const docSections = [
    {
        ...
        description: "Learn about the mission, architecture, and technology stack of WardWork.",
            ...
            <main className="flex-1">
                ...
                <div className="bg-[#DEEFE7]/30 dark:bg-gray-900/50 py-20 border-b border-gray-100 dark:border-gray-800">
                    <div className="container mx-auto px-4 max-w-5xl text-center">
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                            WardWork <span className="text-[#149A9B]">Documentation</span>
                        </h1>
                ...
                <div className="container mx-auto px-4 py-12 max-w-4xl text-center border-t border-gray-50 dark:border-gray-900">
                    ...
                    <div className="flex justify-center gap-6">
                        ...
                        <Link href="https://github.com/WARDWORK/wardwork-monorepo/issues" className="text-[#149A9B] font-semibold hover:underline">GitHub Issues</Link>
                    </div>
                </div>
            </main>
