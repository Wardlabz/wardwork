...
export const metadata: Metadata = {
  title: "Documentation - WARDWORK",
  description: "Complete documentation for WARDWORK Orchestrator",
};

export default function DocsIntroduction() {
  return (
    <article className="prose prose-slate max-w-none">
      <h1 style={{ color: "#19213D" }}>Introduction to WARDWORK</h1>

      <p style={{ color: "#6D758F", fontSize: "1.125rem" }}>
        Welcome to the WARDWORK Orchestrator documentation. WARDWORK is a self-hosted,
        non-custodial payments orchestration platform designed for modern marketplaces.
      </p>

      <h2 style={{ color: "#19213D" }}>What is WARDWORK?</h2>

      <p style={{ color: "#6D758F" }}>
        WARDWORK empowers marketplace operators to provide secure escrow payments without
      ...
      <p style={{ color: "#6D758F" }}>
        Ready to integrate WARDWORK into your marketplace? Check out the{" "}
      ...
      >
        ...
        <p style={{ color: "#6D758F", marginBottom: 0 }}>
          ...
          Core Concepts</a> to understand how WARDWORK works under the hood.
        </p>
      </div>
    </article>
  );
