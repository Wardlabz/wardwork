...
export const metadata: Metadata = {
  ...
  description:
    "Complete technical architecture of WARDWORK: non-custodial escrow on Stellar, Stellar Wallets Kit integration, BlindPay and Abroad off-ramp corridors across 7 LATAM markets. SCF Build Award #44.",
  keywords: [
    "architecture",
    "stellar",
    "soroban",
