...
export const metadata = {
  title: 'WARDWORK | Private Links',
  description: 'Direct access to WARDWORK official links and executive team profiles.',
};
        ...
        <section className="bg-gradient-to-b from-primary-50 via-white to-white py-14 dark:from-gray-900 dark:via-gray-900 dark:to-gray-950">
          <div className="mx-auto max-w-4xl px-4 text-center">
            ...
            <h1 className="mt-6 text-3xl font-bold text-gray-900 dark:text-white">
              WARDWORK official resources
            </h1>
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-300">
              Curated shortcuts to the live product and source code, plus the leadership team behind WARDWORK.
            </p>
          </div>
        </section>
