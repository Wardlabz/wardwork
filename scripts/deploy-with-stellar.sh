...
echo "🚀 Starting WardWork Contract Deployment with Stellar CLI..."
echo "============================================================="
...
cat > $ENV_FILE << EOF
# WardWork Contract Addresses - Generated on $(date)
# Network: $NETWORK
...
print_success "WardWork contracts successfully deployed and configured!"
