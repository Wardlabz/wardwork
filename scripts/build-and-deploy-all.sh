...
DEPLOY_DIR="/Users/kevinbrenes/wardwork/deployments/futurenet"
mkdir -p "$DEPLOY_DIR"
...
for contract in "${contracts[@]}"; do
  ...
  # Compilar
  echo "  Building..."
  cd "/Users/kevinbrenes/wardwork/contracts-offerhub/contracts/$contract"
  soroban contract build
  
  # Desplegar
  echo "  Deploying..."
  WASM_FILE="/Users/kevinbrenes/wardwork/contracts-offerhub/target/wasm32v1-none/release/${contract//-/_}.wasm"
...
cat > "$ENV_FILE" << EOF
# WardWork Contract Addresses - Deployed on $(date)
# Network: Futurenet
