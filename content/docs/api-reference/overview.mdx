---
title: API Overview
description: Introduction to the WARDWORK REST API — authentication, response format, and error handling.
order: 1
section: API Reference
---

The WARDWORK backend exposes a RESTful JSON API at `http://localhost:4000`. All endpoints are prefixed with `/api/v1`.
