---
title: Self-Hosting
description: Complete instructions for deploying WARDWORK on your own infrastructure using Docker.
order: 4
section: Guides
---

Run WARDWORK on your own server with full control over data, uptime, and configuration. This guide covers everything from initial setup to ongoing maintenance using Docker.
...
<CommandLine>git clone https://github.com/WARDWORK/wardwork.git && cd wardwork</CommandLine>
...
<Callout variant="note">
  Check the [GitHub Releases](https://github.com/WARDWORK/wardwork/releases) page for available tags and changelogs.
</Callout>
