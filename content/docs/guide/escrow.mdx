...
ORDER_CREATED
      ↓
FUNDS_RESERVED (off-chain balance lock)
      ↓
ESCROW_CREATING (initializing contract)
      ↓
ESCROW_CREATED (contract deployed)
      ↓
ESCROW_FUNDING (sending USDC on-chain)
      ↓
ESCROW_FUNDED (funds locked in contract)
      ↓
