...
This guide walks you through your first API calls with WardWork Orchestrator. By the end, you'll have created a user, checked their balance, and understand the basic flow.
...
<Callout type="note">
  `externalUserId` is your system's user ID. Use it to link WardWork users to your marketplace users.
</Callout>
