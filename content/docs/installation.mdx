---
title: Installation
description: Set up WardWork Orchestrator locally with Node.js, PostgreSQL, and Redis.
order: 2
section: Getting Started
---

This guide walks you through setting up the WardWork Orchestrator for local development. You can also use the SDK without running your own instance - see [Using the SDK](#using-the-sdk-only) below.
...
DATABASE_URL=postgresql://wardwork:wardwork_password@localhost:5432/wardwork_db
DIRECT_URL=postgresql://wardwork:wardwork_password@localhost:5432/wardwork_db
...
WARDWORK_MASTER_KEY=your-secure-master-key
...
If you want to integrate with an existing WardWork Orchestrator instance (hosted by you or a partner), you only need the SDK:

<CommandLine>npm install @wardwork/sdk</CommandLine>
...
<Callout type="note">
  The installer script `npm create wardwork-orchestrator@latest` is coming soon and will automate this entire setup process.
</Callout>
