...
description: Learn what WARDWORK is, how it works, and how to integrate it into your marketplace.
order: 1
...
WARDWORK uses a **balance-based ledger** and **smart-contract escrow** to protect every transaction:
...
flowchart TB
    ...
    subgraph OH["WARDWORK Orchestrator"]
