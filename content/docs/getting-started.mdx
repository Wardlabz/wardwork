...
<CommandLine>git clone https://github.com/WARDWORK/wardwork-monorepo.git</CommandLine>
...
<Callout type="note">
  Need help? Join our [Discord community](https://discord.gg/offerhub) or open an issue on [GitHub](https://github.com/WARDWORK/wardwork-monorepo/issues).
</Callout>
