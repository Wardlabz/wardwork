...
A comprehensive rating and feedback system for the WardWork platform that integrates with the reputation NFT system to provide transparent, tamper-proof user ratings and feedback.
...
This contract is part of the WardWork platform and follows the project's licensing terms.
